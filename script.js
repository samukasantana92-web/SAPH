/* Pesos da aba "Fórmula e Pesos" da planilha oficial do IPH. */
const pesos = {
    pessoas: 0.1539,
    criancas: 0.1410,
    idosos: 0.1410,
...
function calcularIPH() {
    ...
    /* Notas de 0 a 10, conforme a aba "Fórmula e Pesos". */
    ...
    /* A soma ponderada (0 a 10) é multiplicada por 10: IPH final de 0 a 100. */
    const iph = 10 * (
